...
class ENTRY:
    ...
    This class initializes the simulation workflow by validating command-line
    arguments, parsing the configuration file, computing drone paths, and
    ...
    def main() -> None:
        ...
        try:
            if (len(sys.argv) != 2):
                raise MyError(f"Error: {ENTRY._usage()}")
